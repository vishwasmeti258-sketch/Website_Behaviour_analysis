...
• Traffic source which has good engagement on website.
...
| :--- | :--- |
| **Page Views** | Total number of pages viewed during a session |
| **Session Duration** | Total time a user spent on the site |
| **Bounce Rate** | Percentage of single-page visits |
| **Traffic Source** | Where the user came from (e.g., Organic, Social) |
| **Time on Page** | Average time spent on a specific page |
| **Previous Visits** | Number of times the user visited before |
